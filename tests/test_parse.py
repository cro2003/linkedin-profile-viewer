...
from app.linkedin.client import classify, PermanentError, SessionExpired, TransientError
...
def test_status_classification():
    ...
    assert classify(403) is SessionExpired
    ...
    assert classify(400) is PermanentError
